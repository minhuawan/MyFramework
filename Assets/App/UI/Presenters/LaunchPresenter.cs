...
//             var result = await Application.GetService<UIService>().NavigateLocator(locator);
//             if (result.Type == NavigateResult.ResultType.Ok)
//             {
...
//             await Application.GetService<UIService>().NavigateLocator(locator);
//         }
//
