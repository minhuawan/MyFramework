...
/* 56 */     super(((strings.length + 1) * Pointer.SIZE));
...
/* 64 */         p = ns.getPointer();
/*    */       } 
/* 66 */       setPointer((Pointer.SIZE * i), p);
/*    */     } 
/* 68 */     setPointer((Pointer.SIZE * strings.length), null);
/*    */   }
/*    */ 
/*    */   
/*    */   public void read() {
...
/* 76 */       Pointer p = getPointer((si * Pointer.SIZE));
/* 77 */       Object s = null;
/* 78 */       if (p != null) {
...
/* Location:              D:\files\slayTheSpire-export\!\com\sun\jna\StringArray.class
