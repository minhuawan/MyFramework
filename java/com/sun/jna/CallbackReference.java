...
/*     */     } 
/*     */     
/* 349 */     Method[] methods = pmethods.<Method>toArray(new Method[pmethods.size()]);
...
/* 366 */     this.cbstruct.setInt(Pointer.SIZE, options);
/*     */   }
/*     */ 
/*     */   
...
/* 583 */             Structure s = Structure.newInstance(dstType);
...
/* 588 */             value = s;
/*     */           } else {
/* 590 */             Structure s = Structure.newInstance(dstType, (Pointer)value);
...
/* Location:              D:\files\slayTheSpire-export\!\com\sun\jna\CallbackReference.class
