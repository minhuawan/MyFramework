...
/*     */         
/*     */         private TypeAdapter<T> delegate() {
/* 141 */           TypeAdapter<T> d = this.delegate;
/* 142 */           return (d != null) ? d : (this.delegate = gson.getDelegateAdapter(Excluder.this, type));
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/*     */     }
/*     */     
/* 154 */     if (this.version != -1.0D && !isValidVersion(field.<Since>getAnnotation(Since.class), field.<Until>getAnnotation(Until.class)))
/*     */     {
/* 156 */       return true;
/*     */     }
/*     */     
...
/* 164 */       Expose annotation = field.<Expose>getAnnotation(Expose.class);
...
/*     */     }
/*     */     
/* 178 */     List<ExclusionStrategy> list = serialize ? this.serializationStrategies : this.deserializationStrategies;
/* 179 */     if (!list.isEmpty()) {
...
/* 192 */     if (this.version != -1.0D && !isValidVersion(clazz.<Since>getAnnotation(Since.class), clazz.<Until>getAnnotation(Until.class)))
/*     */     {
/* 194 */       return true;
/*     */     }
/*     */     
...
/*     */     }
/*     */     
/* 205 */     List<ExclusionStrategy> list = serialize ? this.serializationStrategies : this.deserializationStrategies;
...
/* Location:              D:\files\slayTheSpire-export\!\com\google\gson\internal\Excluder.class
