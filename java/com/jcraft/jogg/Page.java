...
/*  78 */     foo = foo << 8L | (this.header_base[this.header + 12] & 0xFF);
/*  79 */     foo = foo << 8L | (this.header_base[this.header + 11] & 0xFF);
/*  80 */     foo = foo << 8L | (this.header_base[this.header + 10] & 0xFF);
/*  81 */     foo = foo << 8L | (this.header_base[this.header + 9] & 0xFF);
/*  82 */     foo = foo << 8L | (this.header_base[this.header + 8] & 0xFF);
/*  83 */     foo = foo << 8L | (this.header_base[this.header + 7] & 0xFF);
/*  84 */     foo = foo << 8L | (this.header_base[this.header + 6] & 0xFF);
/*  85 */     return foo;
/*     */   }
/*     */   
/*     */   public int serialno() {
...
/* Location:              D:\files\slayTheSpire-export\!\com\jcraft\jogg\Page.class
