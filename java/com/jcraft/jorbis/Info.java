...
/* 189 */       this.book_param = new StaticCodeBook[this.books];  int i;
/* 190 */     for (i = 0; i < this.books; i++) {
...
/*     */ 
/*     */     
/* 387 */     opb.write(this.books - 1, 8); int i;
/* 388 */     for (i = 0; i < this.books; i++) {
...
/* Location:              D:\files\slayTheSpire-export\!\com\jcraft\jorbis\Info.class
