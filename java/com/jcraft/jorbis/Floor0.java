...
/*  98 */     return (float)(13.1D * Math.atan(7.4E-4D * f) + 2.24D * Math.atan((f * f) * 1.85E-8D) + 1.0E-4D * f);
/*     */   }
/*     */   
...
/* 149 */           float last = 0.0F;
/*     */           int j;
/* 151 */           for (j = 0; j < look.m; j++) {
/* 152 */             out[j] = 0.0F;
/*     */           }
/* 154 */           for (j = 0; j < look.m; j += b.dim) {
...
/*     */             } 
/*     */           } 
/* 161 */           for (j = 0; j < look.m; ) {
/* 162 */             for (int k = 0; k < b.dim; k++, j++)
/* 163 */               this.lsp[j] = this.lsp[j] + last; 
...
/*     */         } else {
/*     */           
/* 199 */           for (int k = 0; k < lsp.length; k++)
/* 200 */             lsp[k] = 0.0F; 
/*     */         } 
/*     */         int j;
/* 203 */         for (j = 0; j < look.m; j += b.dim) {
/* 204 */           if (b.decodev_set(lsp, j, vb.opb, b.dim) == -1) {
/* 205 */             return null;
/*     */           }
/*     */         } 
/*     */         
/* 209 */         for (j = 0; j < look.m; ) {
/* 210 */           for (int k = 0; k < b.dim; k++, j++)
/* 211 */             lsp[j] = lsp[j] + last; 
/* 212 */           last = lsp[j - 1];
/*     */         } 
/* 214 */         lsp[look.m] = amp;
/* 215 */         return lsp;
...
/* Location:              D:\files\slayTheSpire-export\!\com\jcraft\jorbis\Floor0.class
