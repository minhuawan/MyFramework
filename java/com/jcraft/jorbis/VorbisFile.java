...
/*  152 */         return -1; 
/*  153 */       more = this.oy.pageseek(page);
/*  154 */       if (more < 0) {
...
/*  185 */       while (this.offset < begin + 8500L) {
/*  186 */         int i = get_next_page(page, begin + 8500L - this.offset);
/*  187 */         if (i == -128) {
/*  188 */           return -128;
/*      */         }
/*  190 */         if (i < 0) {
...
/*  225 */       int i = get_next_page(page, -1L);
/*  226 */       if (i == -128)
/*  227 */         return -128; 
/*  228 */       if (i < 0 || page.serialno() != currentno) {
/*  229 */         endsearched = bisect;
/*  230 */         if (i >= 0)
/*  231 */           next = i; 
/*      */         continue;
/*      */       } 
/*  234 */       searched = (i + page.header_len + page.body_len);
/*      */     } 
/*      */     
...
/* 1002 */       int i = (int)(pos - this.pcm_offset);
...
/*      */ 
/*      */     
/* 1054 */     long target = (long)((float)pcm_total + (seconds - time_total) * (this.vi[link]).rate);
...
/* Location:              D:\files\slayTheSpire-export\!\com\jcraft\jorbis\VorbisFile.class
