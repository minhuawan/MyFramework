...
/* 101 */       for (int j = 0; j < info.coupling_steps; j++) {
/* 102 */         opb.write(info.coupling_mag[j], Util.ilog2(vi.channels));
/* 103 */         opb.write(info.coupling_ang[j], Util.ilog2(vi.channels));
/*     */       } 
/*     */     } else {
/*     */       
/* 107 */       opb.write(0, 1);
...
/* 114 */       for (int j = 0; j < vi.channels; j++) {
/* 115 */         opb.write(info.chmuxlist[j], 4);
/*     */       } 
...
/*     */       
/* 138 */       for (int j = 0; j < info.coupling_steps; j++) {
/* 139 */         int testM = info.coupling_mag[j] = opb.read(Util.ilog2(vi.channels));
/* 140 */         int testA = info.coupling_ang[j] = opb.read(Util.ilog2(vi.channels));
/*     */         
...
/* 157 */       for (int j = 0; j < vi.channels; j++) {
/* 158 */         info.chmuxlist[j] = opb.read(4);
/* 159 */         if (info.chmuxlist[j] >= info.submaps) {
/* 160 */           info.free();
/* 161 */           return null;
/*     */         } 
/*     */       } 
...
/*     */ 
/*     */     
/* 231 */     for (i = 0; i < info.coupling_steps; i++) {
...
/*     */ 
/*     */     
/* 258 */     for (i = info.coupling_steps - 1; i >= 0; i--) {
...
/* Location:              D:\files\slayTheSpire-export\!\com\jcraft\jorbis\Mapping0.class
