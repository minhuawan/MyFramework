...
/*     */       
/*     */       case 0:
/* 102 */         leftbegin = window / 4 - left / 2;
/* 103 */         rightbegin = window - window / 4 - right / 2;
/*     */         
/* 105 */         for (i = 0; i < left; i++) {
/* 106 */           float x = (float)((i + 0.5D) / left * 3.1415927410125732D / 2.0D);
/* 107 */           x = (float)Math.sin(x);
/* 108 */           x *= x;
/* 109 */           x = (float)(x * 1.5707963705062866D);
/* 110 */           x = (float)Math.sin(x);
/* 111 */           ret[i + leftbegin] = x;
/*     */         } 
/*     */         
/* 114 */         for (i = leftbegin + left; i < rightbegin; i++) {
/* 115 */           ret[i] = 1.0F;
/*     */         }
/*     */         
/* 118 */         for (i = 0; i < right; i++) {
/* 119 */           float x = (float)(((right - i) - 0.5D) / right * 3.1415927410125732D / 2.0D);
/* 120 */           x = (float)Math.sin(x);
/* 121 */           x *= x;
/* 122 */           x = (float)(x * 1.5707963705062866D);
...
/* 309 */         this.pcm[j][_pcm + i] = this.pcm[j][_pcm + i] + vb.pcm[j][i];
/*     */       }
/*     */       
/* 312 */       for (; i < sizeW; i++) {
...
/* Location:              D:\files\slayTheSpire-export\!\com\jcraft\jorbis\DspState.class
