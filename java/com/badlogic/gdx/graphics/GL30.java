...
public interface GL30 extends GL20 {
  ...
  void glReadBuffer(int paramInt);
  
  void glDrawRangeElements(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, Buffer paramBuffer);
  
  void glDrawRangeElements(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6);
  
  void glTexImage3D(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8, int paramInt9, Buffer paramBuffer);
  
  void glTexImage3D(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8, int paramInt9, int paramInt10);
  
  void glTexSubImage3D(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8, int paramInt9, int paramInt10, Buffer paramBuffer);
  
  void glTexSubImage3D(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8, int paramInt9, int paramInt10, int paramInt11);
  
  void glCopyTexSubImage3D(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8, int paramInt9);
  
  void glGenQueries(int paramInt1, int[] paramArrayOfint, int paramInt2);
  
  void glGenQueries(int paramInt, IntBuffer paramIntBuffer);
  
  void glDeleteQueries(int paramInt1, int[] paramArrayOfint, int paramInt2);
  
  void glDeleteQueries(int paramInt, IntBuffer paramIntBuffer);
  
  boolean glIsQuery(int paramInt);
  
  void glBeginQuery(int paramInt1, int paramInt2);
  
  void glEndQuery(int paramInt);
  
  void glGetQueryiv(int paramInt1, int paramInt2, IntBuffer paramIntBuffer);
  
  void glGetQueryObjectuiv(int paramInt1, int paramInt2, IntBuffer paramIntBuffer);
  
  boolean glUnmapBuffer(int paramInt);
  
  Buffer glGetBufferPointerv(int paramInt1, int paramInt2);
  
  void glDrawBuffers(int paramInt, IntBuffer paramIntBuffer);
  
  void glUniformMatrix2x3fv(int paramInt1, int paramInt2, boolean paramBoolean, FloatBuffer paramFloatBuffer);
  
  void glUniformMatrix3x2fv(int paramInt1, int paramInt2, boolean paramBoolean, FloatBuffer paramFloatBuffer);
  
  void glUniformMatrix2x4fv(int paramInt1, int paramInt2, boolean paramBoolean, FloatBuffer paramFloatBuffer);
  
  void glUniformMatrix4x2fv(int paramInt1, int paramInt2, boolean paramBoolean, FloatBuffer paramFloatBuffer);
  
  void glUniformMatrix3x4fv(int paramInt1, int paramInt2, boolean paramBoolean, FloatBuffer paramFloatBuffer);
  
  void glUniformMatrix4x3fv(int paramInt1, int paramInt2, boolean paramBoolean, FloatBuffer paramFloatBuffer);
  
  void glBlitFramebuffer(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8, int paramInt9, int paramInt10);
  
  void glRenderbufferStorageMultisample(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5);
  
  void glFramebufferTextureLayer(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5);
  
  void glFlushMappedBufferRange(int paramInt1, int paramInt2, int paramInt3);
  
  void glBindVertexArray(int paramInt);
  
  void glDeleteVertexArrays(int paramInt1, int[] paramArrayOfint, int paramInt2);
  
  void glDeleteVertexArrays(int paramInt, IntBuffer paramIntBuffer);
  
  void glGenVertexArrays(int paramInt1, int[] paramArrayOfint, int paramInt2);
  
  void glGenVertexArrays(int paramInt, IntBuffer paramIntBuffer);
  
  boolean glIsVertexArray(int paramInt);
  
  void glBeginTransformFeedback(int paramInt);
  
  void glEndTransformFeedback();
  
  void glBindBufferRange(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5);
  
  void glBindBufferBase(int paramInt1, int paramInt2, int paramInt3);
  
  void glTransformFeedbackVaryings(int paramInt1, String[] paramArrayOfString, int paramInt2);
  
  void glVertexAttribIPointer(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5);
  
  void glGetVertexAttribIiv(int paramInt1, int paramInt2, IntBuffer paramIntBuffer);
  
  void glGetVertexAttribIuiv(int paramInt1, int paramInt2, IntBuffer paramIntBuffer);
  
  void glVertexAttribI4i(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5);
  
  void glVertexAttribI4ui(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5);
  
  void glGetUniformuiv(int paramInt1, int paramInt2, IntBuffer paramIntBuffer);
  
  int glGetFragDataLocation(int paramInt, String paramString);
  
  void glUniform1uiv(int paramInt1, int paramInt2, IntBuffer paramIntBuffer);
  
  void glUniform3uiv(int paramInt1, int paramInt2, IntBuffer paramIntBuffer);
  
  void glUniform4uiv(int paramInt1, int paramInt2, IntBuffer paramIntBuffer);
  
  void glClearBufferiv(int paramInt1, int paramInt2, IntBuffer paramIntBuffer);
  
  void glClearBufferuiv(int paramInt1, int paramInt2, IntBuffer paramIntBuffer);
  
  void glClearBufferfv(int paramInt1, int paramInt2, FloatBuffer paramFloatBuffer);
  
  void glClearBufferfi(int paramInt1, int paramInt2, float paramFloat, int paramInt3);
  
  String glGetStringi(int paramInt1, int paramInt2);
  
  void glCopyBufferSubData(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5);
  
  void glGetUniformIndices(int paramInt, String[] paramArrayOfString, IntBuffer paramIntBuffer);
  
  void glGetActiveUniformsiv(int paramInt1, int paramInt2, IntBuffer paramIntBuffer1, int paramInt3, IntBuffer paramIntBuffer2);
  
  int glGetUniformBlockIndex(int paramInt, String paramString);
  
  void glGetActiveUniformBlockiv(int paramInt1, int paramInt2, int paramInt3, IntBuffer paramIntBuffer);
  
  void glGetActiveUniformBlockName(int paramInt1, int paramInt2, Buffer paramBuffer1, Buffer paramBuffer2);
  
  String glGetActiveUniformBlockName(int paramInt1, int paramInt2);
  
  void glUniformBlockBinding(int paramInt1, int paramInt2, int paramInt3);
  
  void glDrawArraysInstanced(int paramInt1, int paramInt2, int paramInt3, int paramInt4);
  
  void glDrawElementsInstanced(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5);
  
  void glGetInteger64v(int paramInt, LongBuffer paramLongBuffer);
  
  void glGetBufferParameteri64v(int paramInt1, int paramInt2, LongBuffer paramLongBuffer);
  
  void glGenSamplers(int paramInt1, int[] paramArrayOfint, int paramInt2);
  
  void glGenSamplers(int paramInt, IntBuffer paramIntBuffer);
  
  void glDeleteSamplers(int paramInt1, int[] paramArrayOfint, int paramInt2);
  
  void glDeleteSamplers(int paramInt, IntBuffer paramIntBuffer);
  
  boolean glIsSampler(int paramInt);
  
  void glBindSampler(int paramInt1, int paramInt2);
  
  void glSamplerParameteri(int paramInt1, int paramInt2, int paramInt3);
  
  void glSamplerParameteriv(int paramInt1, int paramInt2, IntBuffer paramIntBuffer);
  
  void glSamplerParameterf(int paramInt1, int paramInt2, float paramFloat);
  
  void glSamplerParameterfv(int paramInt1, int paramInt2, FloatBuffer paramFloatBuffer);
  
  void glGetSamplerParameteriv(int paramInt1, int paramInt2, IntBuffer paramIntBuffer);
  
  void glGetSamplerParameterfv(int paramInt1, int paramInt2, FloatBuffer paramFloatBuffer);
  
  void glVertexAttribDivisor(int paramInt1, int paramInt2);
  
  void glBindTransformFeedback(int paramInt1, int paramInt2);
  
  void glDeleteTransformFeedbacks(int paramInt1, int[] paramArrayOfint, int paramInt2);
  
  void glDeleteTransformFeedbacks(int paramInt, IntBuffer paramIntBuffer);
  
  void glGenTransformFeedbacks(int paramInt1, int[] paramArrayOfint, int paramInt2);
  
  void glGenTransformFeedbacks(int paramInt, IntBuffer paramIntBuffer);
  
  boolean glIsTransformFeedback(int paramInt);
  
  void glPauseTransformFeedback();
  
  void glResumeTransformFeedback();
  
  void glProgramParameteri(int paramInt1, int paramInt2, int paramInt3);
  
  void glInvalidateFramebuffer(int paramInt1, int paramInt2, IntBuffer paramIntBuffer);
  
  void glInvalidateSubFramebuffer(int paramInt1, int paramInt2, IntBuffer paramIntBuffer, int paramInt3, int paramInt4, int paramInt5, int paramInt6);
...
/* Location:              D:\files\slayTheSpire-export\!\com\badlogic\gdx\graphics\GL30.class
